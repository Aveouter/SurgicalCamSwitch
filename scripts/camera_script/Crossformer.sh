...
for ty in sequence-out surgery-out ; do
  for datascv in  total_data_20221110.csv total_data_20220722.csv total_data_20220729.csv total_data_20220801.csv total_data_20230315.csv; do  #  total_data_20221110.csv
    python -u run.py \
